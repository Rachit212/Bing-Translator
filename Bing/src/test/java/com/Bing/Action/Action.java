...
//	public  String executeJavascriptReturnsString(String script) {
...
//	}
	...
	public void Swap_Values() throws InterruptedException {
		...
		js.executeScript("document.geElementById('t_dummydiv').innerHTML");
		//String g=js.executeJavascriptReturnsString($('#t_dummydiv').innerHTML);
		
//		Swap_Values a=new Swap_Values();
//		a.executeJavascriptReturnsString("$('#t_dummydiv').innerHTML");
//		//WebElement translate = driver.findElement(By.id("t_dummydiv"));
//		String trn = translate.getText();
//		Assert.assertEquals("Hello",trn);
